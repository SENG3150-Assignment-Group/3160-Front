...
const getRandomCode = (airline) => {
    ...
    return airlineCodes[airline].toString() + random(9999).toString().padEnd(4, "0");
};

const getRandomDate = () => {
    return (random(2) + 2022) + "-" + (random(11) + 1).toString().padStart(2, "0") + "-" + (random(27) + 1).toString().padStart(2, "0");
};
...
saveFlights(generateFlightsJSON(10000));
